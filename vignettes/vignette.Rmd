...
#To install from github (Depending on the configuration of the local computer or HPC, possible C++ compilation troubleshotings may be required - see installation troubleshoot below) 
...
#check in scGPS/src if any of the precompiled (e.g. those with *.so and *.o) files exist and delete them before recompiling
