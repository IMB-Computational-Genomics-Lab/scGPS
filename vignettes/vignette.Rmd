...
```
#A complete workflow of the scGPS: given an unknown mixed popultation,find clusters 
#and estimate relationship between clusters 
...
#perform between cluster prediction 
