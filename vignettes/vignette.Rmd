...
clustering_after_outlier_removal <- unlist(CORE_cluster$Cluster[[optimal_index]])
corresponding_cells_after_outlier_removal <- CORE_cluster$cellsForClustering
original_cells_before_removal <- colData(mixedpop2)[,1]
corresponding_index <- match(corresponding_cells_after_outlier_removal, original_cells_before_removal )
# check the matching 
identical(original_cells_before_removal[corresponding_index],corresponding_cells_after_outlier_removal)
