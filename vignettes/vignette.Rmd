...
```
##2.2 Run prediction
```{r run prediction, warning = FALSE, message = FALSE, eval = FALSE}
...
```{r summarise results, warning = FALSE, message = FALSE, eval = FALSE}
...
```{r CORE clustering, warning = FALSE, message = FALSE, eval = FALSE}
...
c_selectID <- 1
genes = DEgenes$DE_Subpop1vsRemaining$id[1:500] #top 200 gene markers distinguishing cluster 1 

sink("temp")
LSOLDA_dat1 <- bootstrap_scGPS(nboots = 2, mixedpop1 = mixedpop1, mixedpop2 = mixedpop2, genes=genes, c_selectID = c_selectID , listData =list(), cluster_mixedpop1 = cluster_mixedpop1, cluster_mixedpop2 = cluster_mixedpop2)
sink()
...
```{r visualise prediction one sample,warning = FALSE, message = FALSE, eval = FALSE }
#run prediction for 3 clusters 
cluster_mixedpop1 <- colData(mixedpop1)[,1]
cluster_mixedpop2 <- as.numeric(as.vector(colData(mixedpop2)[,1]))
...
```{r visualise prediction two samples,warning = FALSE, message = FALSE, eval = FALSE}
#run prediction for 3 clusters 
cluster_mixedpop1 <- colData(mixedpop1)[,1]
cluster_mixedpop2 <- as.numeric(as.vector(colData(mixedpop2)[,1]))
row_cluster <-length(unique(colData(mixedpop2)[,1]))
