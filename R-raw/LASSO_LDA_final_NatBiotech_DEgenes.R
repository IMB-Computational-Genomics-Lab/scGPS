...
bootstrap_run <- function(bootstrap_number=100){
  #Lists to be saved. Note that only list_predict_sameDay and list_predict_DifferentDay are day-specific;
  #all others are shared for the same models LASSO or LDA
